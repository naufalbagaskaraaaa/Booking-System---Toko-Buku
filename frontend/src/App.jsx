...
function App() {
  ...
  return (
    <div style={{ padding: "40px 20px", fontFamily: "'Inter', sans-serif", minHeight: "100vh", backgroundColor: "#1f2937", color: "#f9fafb" }}>
      <div style={{ maxWidth: "750px", margin: "auto" }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleAddOrUpdateBook} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <input
              ...
              style={{ padding: "12px", borderRadius: "8px", border: "1px solid #d1d5db", backgroundColor: "#f9fafb", color: "#111827", fontSize: "1rem" }}
            />
            <input
              type="text"
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "5px" }}>
              <button
                type="submit"
                style={{ flex: 1, padding: "12px", backgroundColor: isEditMode ? "#6366f1" : "#10b981", color: "white", border: "none", borderRadius: "8px", fontSize: "1rem", fontWeight: "600", cursor: "pointer" }}
              >
              ...
              {isEditMode && (
                <button
                  type="button"
                  onClick={resetForm}
                  style={{ padding: "12px", backgroundColor: "#ef4444", color: "white", border: "none", borderRadius: "8px", fontSize: "1rem", fontWeight: "600", cursor: "pointer" }}
                >
                  Batal
                </button>
              )}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", alignItems: "flex-end" }}>
                  ...
                  <div style={{ display: "flex", gap: "10px" }}>
                    <button
                      ...
                      style={{ padding: "10px 15px", backgroundColor: "#f59e0b", color: "#ffffff", border: "none", borderRadius: "8px", cursor: "pointer", fontWeight: "600", fontSize: "0.95rem" }}
                    >
                      Kembalikan
                    </button>
        ...
        <div style={{ marginTop: "40px", backgroundColor: "#ffffff", padding: "20px", borderRadius: "12px", color: "#111827" }}>
                    ...
                    <tr key={h.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
                      ...
                      <td style={{ padding: "10px" }}>
                        <span style={{
                          padding: "4px 8px",
                          borderRadius: "4px",
                          backgroundColor: h.status === 'Dipinjam' ? '#fef3c7' : '#d1fae5',
                          color: h.status === 'Dipinjam' ? '#92400e' : '#065f46',
                          fontWeight: "bold",
                          fontSize: "0.8rem"
                        }}>
                          {h.status}
