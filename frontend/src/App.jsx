...
function App() {
  ...
  const [role, setRole] = useState("pengunjung");
  ...
  const handleBooking = (ID_Buku, Judul) => {
    ...
    fetch(`${BASE_URL}/api/book`, {
      ...
      .then(() => {
        alert(`${Judul} berhasil dipinjam oleh ${borrower}!`);
        fetchBooks();
        fetchHistories();
      })
  ...
  const handleReturn = (ID_Buku, Judul) => {
    fetch(`${BASE_URL}/api/return`, {
      ...
      .then(() => {
        alert(`${Judul} berhasil dikembalikan!`);
        fetchBooks();
        fetchHistories();
      })
      .catch((error) => alert(`Gagal: ${error.message}`));
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: "0.9rem",
              fontWeight: "600",
              color: activePage === "books" ? "#10b981" : "#9ca3af",
              borderBottom:
                activePage === "books"
                  ? "2px solid #10b981"
          ...
          {isAdmin && (
            <button
              ...
              style={{
                ...
                fontSize: "0.9rem",
                fontWeight: "600",
                color: activePage === "history" ? "#10b981" : "#9ca3af",
                borderBottom:
                  activePage === "history"
                    ? "2px solid #10b981"
                    : "2px solid transparent",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span
            style={{ fontSize: "0.8rem", color: "#6b7280", marginRight: "4px" }}
          >
            Mode:
          </span>
          <button
            onClick={() => handleRoleSwitch("pengunjung")}
            style={{
              padding: "7px 16px",
              borderRadius: "9999px",
              border: "none",
              ...
              fontSize: "0.85rem",
              fontWeight: "600",
              backgroundColor: !isAdmin ? "#10b981" : "#374151",
              color: !isAdmin ? "white" : "#9ca3af",
              transition: "all 0.2s",
            }}
          >
            Pengunjung
          ...
          <button
            ...
            style={{
              ...
              fontSize: "0.85rem",
              fontWeight: "600",
              backgroundColor: isAdmin ? "#6366f1" : "#374151",
              color: isAdmin ? "white" : "#9ca3af",
              transition: "all 0.2s",
            }}
          >
          ...
          {activePage === "books" && (
            <>
              <div style={{ textAlign: "center", marginBottom: "30px" }}>
                ...
                <p style={{ color: "#9ca3af", margin: "0 0 10px 0" }}>
                  Booking System
                </p>
                <span
                  style={{
                    ...
                    fontSize: "0.8rem",
                    fontWeight: "600",
                    backgroundColor: isAdmin ? "#4f46e5" : "#065f46",
                    color: "white",
                  }}
                >
                  {isAdmin ? "Mode Admin" : "Mode Customer"}
                </span>
              </div>
              ...
              {isAdmin && (
                ...
                >
                  ...
                  >
                    {isEditMode ? "Edit Buku" : "Tambah Koleksi Baru"}
                  </h3>
                  <form
                  ...
                  >
                    <input
                      type="text"
                      placeholder="Judul Buku (Cth: Bumi Manusia)"
                      value={newJudul}
                    ...
                    >
                      <button
                        ...
                        style={{
                          flex: 1,
                          padding: "12px",
                          backgroundColor: isEditMode ? "#6366f1" : "#10b981",
                          color: "white",
                          border: "none",
                          borderRadius: "8px",
                          fontSize: "1rem",
              ...
              <div style={{ position: "relative", display: "inline-block" }}>
                ...
                <input
                  type="text"
                  placeholder="mau cari buku apa nih??.."
                  value={searchTerm}
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "8px" }}>
                          {isAdmin && (
                            <button
                              onClick={() =>
                                handleReturn(book.id_buku, book.judul)
                              }
                              disabled={book.active_borrow_id === 0}
                              style={{
                                padding: "10px 15px",
                                backgroundColor:
                                  book.active_borrow_id !== 0
                                    ? "#f59e0b"
                                    : "#e5e7eb",
                                color:
                                  book.active_borrow_id !== 0
                          ...
                          <button
                            onClick={() =>
                              handleBooking(book.id_buku, book.judul)
                            }
                            disabled={book.stock === 0}
                            style={{
                              padding: "10px 20px",
                              backgroundColor:
                                book.stock > 0 ? "#3b82f6" : "#e5e7eb",
                              color: book.stock > 0 ? "#fff" : "#9ca3af",
                              border: "none",
                              borderRadius: "8px",
                              cursor:
                                book.stock > 0 ? "pointer" : "not-allowed",
                              fontWeight: "600",
                              fontSize: "0.95rem",
                            }}
                          >
                      ...
                      {histories.map((h) => (
                        ...
                        >
                          ...
                          <td style={{ padding: "10px", color: "#6b7280" }}>
                            {new Date(h.borrow_date).toLocaleString("id-ID")}
                          </td>
